                ...
                <div class="flex col">
                    <div class="flex row baseline space-between">
                        ...
                        <div class="flex row baseline">
                            ...
                            <div class="flex row align-items-center gap-5">${data.onSale ? `<p class="discount">${data.price}</p> <p class="red price">${data.discountedPrice}</p>`: `<p class="price white">${data.price}</p>`}</div>
                        </div>
                    </div>
                        <ul class="product-info">
                            ...
                            <li>
                                <p>Age Rating:</p>
                                <p class="white">${data.ageRating}</p>
                            </li>
                            <li>
                                <p>Release Date:</p>
                                <p class="white">${data.released}</p>
                            </li>
                            <li>
                                <p>Description:</p>
